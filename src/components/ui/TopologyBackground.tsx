...
export default function TopologyBackground() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, background: "#03040a", overflow: "hidden", pointerEvents: "none" }}>
      <canvas
        ref={canvasRef}
        style={{ position: "absolute", inset: 0, width: "100%", height: "100%", display: "block" }}
      />
      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at center, transparent 30%, #03040a 110%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 55%, #03040a 100%)", pointerEvents: "none" }} />
    </div>
  );
}
